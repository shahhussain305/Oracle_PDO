...
class SG{
	...
	//contents goes here
	//SG::end_card();
	public static function create_card($titleText,$card_bg='bg-dark text-white',$cardColor='text-bg-light',$style='style="width:100%; margin:0 auto;"'){
		try{
	...
	public static function page_footer(){
		$footer = '<div class="minHeight bg-light border border-2 text-white">
					<div class="container">
						<div class="row">
								<div class="col-sm-12 col-md-6 col-lg-6 p-2 text-secondary">
									<strong class="text-primary">Quick Links</strong>
										<div class="items">
											<ul>
												<li><a href="'.self::getBaseUrl().'/home.phc">Case Search</a></li>
												<li><a href="https://sessionscourtpeshawar.gov.pk/public/app">Official Website</a></li>
											</ul>
											<hr>
											<div><strong class="text-primay"> Other Important Links</strong></div>
											<ul>
												<li><a href="">Supreme Court of Pakistan</a></li>
												<li><a href="">Peshawar High Court</a></li>
												<li><a href="">Peshawar High Court Abbottabad, Bench</a></li>
												<li><a href="">Peshawar High Court Mingora, Bench</a></li>
												<li><a href="">Peshawar High Court Bannu, Bench</a></li>
											</ul>
										</div>
								</div>
